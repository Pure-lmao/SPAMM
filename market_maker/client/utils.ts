...
import { getMmConfigPda, getMmParlayQuoteBufferPda, getMmQuoteBufferPda, MARKET_MAKER_PROGRAM_ID } from 'spamm-market-maker-sdk';
...
// const [mmPQBufferPda] = await getMmParlayQuoteBufferPda(MARKET_MAKER_PROGRAM_ID);
// console.log(mmPQBufferPda);
// console.log(formatAddressAsRustNewFromArrayBody(mmPQBufferPda));
