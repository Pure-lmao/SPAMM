...
/// RFQ signed-message network domain values (first byte of canonical quote messages).
...
// pub const RFQ_NETWORK_DOMAIN: u8 = RFQ_NETWORK_MAINNET;
...
// pub const INIT_PROGRAM_RECENT_SLOT: u64 = 425128422;

// // 9cg4mZSLwjtL3D2JBhockpfw7kprmrXxcg6K5Um68Pga.
// pub const LOOKUP_TABLE: Address = Address::new_from_array([
//    0x80, 0x00, 0xfe, 0xa0, 0x21, 0x81, 0xb8, 0xbf, 0x6b, 0x05, 0x72, 0xad, 0x19, 0xd9, 0x17, 0x21, 
//    0x52, 0xbc, 0x33, 0x68, 0x07, 0xbc, 0x34, 0x46, 0xc1, 0xd2, 0xf9, 0xfd, 0x37, 0x1d, 0xe4, 0xb7,
// ]);

//--------DEVNET CONSTANTS--------

// /// Baked into RFQ ed25519 messages so a quote from another cluster cannot verify here.
pub const RFQ_NETWORK_DOMAIN: u8 = RFQ_NETWORK_DEVNET;
...
/// Recent slot used for the ALT PDA(`CONFIG_PDA`, this slot) == [`LOOKUP_TABLE`].
pub const INIT_PROGRAM_RECENT_SLOT: u64 = 465810424;

// XRCYQiVHeE3Q83v4piQh2yHiyVmr62MikYacgYBZnYt.
pub const LOOKUP_TABLE: Address = Address::new_from_array([
   0x07, 0xca, 0xc9, 0x41, 0xc2, 0x91, 0x1e, 0x91, 0xb6, 0x91, 0x97, 0x66, 0x97, 0x5f, 0xac, 0xe2, 
   0x27, 0xfe, 0x91, 0x79, 0x1c, 0x89, 0x2d, 0x46, 0x7b, 0x44, 0xdb, 0xa9, 0xab, 0xdb, 0x1a, 0xcd,
]);